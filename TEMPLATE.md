...
I maintain [{{ PYPI_PACKAGES }} Python packages](https://pypi.org/user/d33bs/) on PyPI (downloaded [{{ PYPI_DOWNLOADS }} times](https://pypistats.org) last month), have [{{ ZENODO_ARCHIVES }} archived releases](https://zenodo.org/search?q=creators.orcid:0000-0001-6041-3665) on Zenodo, and my work has received [{{ CITATION_COUNT }} citations](https://openalex.org/authors/A5094319301).
